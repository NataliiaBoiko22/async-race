...
export const winnerCreator = async function (id) {
    ...
    winnerHTML.innerHTML = `
                                ...
                                <td class="number"></td>
                                <td class="car_mini">
                                <svg class="car_img_mini" id="${id}"
                                fill="${car.color}"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
                                ...
                                <td class="car_mini_name">${car.name}</td>
                                <td class="car_mini_wins">${winner.wins}</td>
                                <td class="car_mini_time">${winner.time}</td>
                                `;

    document.querySelector(".winners_body").append(winnerHTML);
    countWinner();
    btnWinnersDesabling();
  };
