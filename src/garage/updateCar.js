// !----------------------------------UPDATE-CAR-------------
import { getCar, updateCar } from "../store/api-servise";
import { updateBTN } from "../view/view";
import { updateCarInput, updateCarColor } from "../view/view";
export const updateCarFunc = async function (id) {
  const car = await getCar(id);
  let carName = document.getElementById(`${id}-NAME`);
  updateBTN.disabled = false;
  updateCarInput.value = car.name;
  updateCarColor.value = car.color;
  carName.classList.add("active");
};
export const clickUpdateBTN = async function () {
...
export function carModificator(carName, carColor, carID) {
